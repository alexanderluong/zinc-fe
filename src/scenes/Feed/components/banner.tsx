...
const Banner: React.FC<BannerProps> = ({ loggedIn, firstName }) => {
  ...
  return (
    <React.Fragment>
      <div id="edge-banner" className={loggedInClass}></div>
      <div id="banner-container" className={loggedInClass}></div>
      <div id="banner" className={loggedInClass}>
        <div className={"welcome-text " + loggedInClass}>
